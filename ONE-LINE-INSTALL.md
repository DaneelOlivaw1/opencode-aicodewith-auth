# 一键安装：opencode-aicodewith-auth + oh-my-opencode
...
2. 拥有 AICodewith API key（在 https://aicodewith.com/ 注册）
...
- **opencode-aicodewith-auth**: https://github.com/DaneelOlivaw1/opencode-aicodewith-auth
